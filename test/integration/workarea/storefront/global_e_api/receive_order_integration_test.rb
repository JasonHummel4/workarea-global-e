    ...
    module GlobalEAPi
      class ReceiveOrderIntegrationTest < Workarea::IntegrationTest
        ...
        def test_with_tax_subsidy_discount
          ...
          assert_equal 53.03.to_m, order.duties_and_taxes_nonsubsidized
          assert_equal 53.03.to_m, order.duties_and_taxes_subsidized
          assert_equal 0.to_m, order.tax_total
        end
